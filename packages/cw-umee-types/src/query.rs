...
use crate::query_oracle::{
  ...
  ASSIGNED_QUERY_EXCHANGE_RATES, ASSIGNED_QUERY_FEEDER_DELEGATION, ASSIGNED_QUERY_MEDIANS,
  ASSIGNED_QUERY_MEDIAN_DEVIATIONS, ASSIGNED_QUERY_MISS_COUNTER, ASSIGNED_QUERY_ORACLE_PARAMS,
